...
/**
 * \brief A function that executes the form given as a parameter
 *
 * Executes the form.
 * If successful, informs that the form is executed.
 * If not, informs error.
 */
void	Bureaucrat::executeForm(const AForm& form) const
{
	...
	{
		std::cerr << e.what() << ": [" << name << "] couldn't execute the form [" << form.getName() << "]" << std::endl;
	}
}
